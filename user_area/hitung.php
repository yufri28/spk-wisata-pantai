...
a.longitude,
a.alamat,
a.gambar, a.rating, a.biaya_alt, a.fasilitas_alt, a.jarak_alt, 
...
JOIN kecocokan_alt_kriteria kak ON a.id_alternatif = kak.f_id_alternatif
JOIN sub_kriteria sk ON kak.f_id_sub_kriteria = sk.id_sub_kriteria
JOIN kriteria k ON kak.f_id_kriteria = k.id_kriteria)* ($bobot_c5)) AS norm_C5
...
$ap_am = $koneksi->query(
    ...
    NULL AS C4,
    NULL AS C5,
    IF('$c1'='benefit', MIN(norm_C1), MAX(norm_C1)) AS norm___C1,
    IF('$c2'='cost', MAX(norm_C2), MIN(norm_C2)) AS norm___C2,
...
SELECT 
    ...
    NULL AS C4,
    NULL AS C5,
    IF('$c1'='benefit', MAX(norm_C1), MIN(norm_C1)) AS norm__C1,
    IF('$c2'='cost', MIN(norm_C2), MAX(norm_C2)) AS norm__C2,
    IF('$c3'='cost', MAX(norm_C3), MIN(norm_C3)) AS norm__C3,
    IF('$c4'='benefit', MIN(norm_C4), MAX(norm_C4)) AS norm__C4,
    IF('$c5'='benefit', MIN(norm_C5), MAX(norm_C5)) AS norm__C5
FROM (
    SELECT 
        a.nama_alternatif, 
        a.id_alternatif,
